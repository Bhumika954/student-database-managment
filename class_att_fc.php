    ...
    <form action="" method="post">
        ...
        <table class="tab_one" style="text-align:center;">
            ...
            while($rows = $alluser->fetch_assoc()){
                ...
                $total_classes = $user->get_total_classes($rows['st_id']);
                $present_count = $user->get_present_count($rows['st_id']);
        ...
        <span style="margin-left:360px;"><input style="background:#58A85D;border:none;color:#fff;padding:8px 100px;" type="submit" name="submit" value="Submit" /></span>
    </form>
</div>
